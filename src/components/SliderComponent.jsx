...
const SliderComponent = () => {
  ...
  return (
    <div className="container my-4">
      <Slider {...settings}>
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
          <i className="bi bi-headset fs-1 text-warning"></i>
          <p className="mt-2">100+ Service Centers</p>
        </div>
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
          <i className="bi bi-calendar4-week fs-1 text-success"></i>
          <p className="mt-2">40+ Yrs of Legacy</p>
        </div>
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
        ...
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
          ...
          <p className="mt-2">Global Recognition</p>
        </div>
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
          <i className="bi bi-patch-check fs-1 text-danger"></i>
          <p className="mt-2">ISO & ISI Certified</p>
        </div>
        <div className="text-center text-center1 p-4 bg-dark text-white rounded">
          <i className="bi bi-map fs-1 text-warning"></i>
          <p className="mt-2">Nationwide Distribution</p>
        </div>
      </Slider>
    </div>
  );
